...
def model_run(filename):
    ...
    sample.datacollector_df.to_csv(rootpath+'experiment/segregated/scenario4c_2pp/'+str(outputfile))
    seeded_df['seeded_agents']=sample.seeded_agents
    seeded_df.to_csv(rootpath+'experiment/segregated/scenario4c_2pp/seeds/'+str(outputfile))    
