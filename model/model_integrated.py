...
class AdoptionModel(Model):
    ...
    def __init__(self,filename):
        ...
        self.intention_threshold = {0:0.80,1:0.80,2:0.82,3:0.87,4:0.89,5:0.90,6:0.92,7:0.92,8:0.93,9:0.94}
...
def model_run(filename):
    ...
    sample.datacollector_df.to_csv(rootpath+'experiment/integrated/scenario1/tax46'+str(outputfile))
