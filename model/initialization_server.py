...
def initialize(file):
    ...
    df.to_csv(rootpath+f'data/init_output/{file[100:-4]}_initialized.csv')
    print(f'finished exporting the initialized file of {file[100:-4]}.csv')
