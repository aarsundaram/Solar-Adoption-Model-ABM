...
def model_run(filename):
    ...
    sample.datacollector_df.to_csv(rootpath+'experiment/integrated/scenario3/scenario3b/'+str(outputfile))
    seeded_df['seeded_agents']= sample.seeded_agents
    seeded_df.to_csv(rootpath+'experiment/integrated/scenario3/scenario3b/seeds/'+str(outputfile))
